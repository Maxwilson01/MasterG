...
--
-- Host: 127.0.0.1
-- Generation Time: 02-Maio-2017 às 16:30
...
-- Database: `masterg`
--
CREATE DATABASE IF NOT EXISTS `masterg` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `masterg`;
